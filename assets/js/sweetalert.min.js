!(function (e, t) {
		...
		Ze = e => {
			...
			for (const o in e)
				(n = o),
					...
					e.toast &&
						((t = o), _e.includes(t) && s('The parameter "'.concat(t, '" is incompatible with toasts'))),
					(t = o),
					Ye(t) && i(t, Ye(t));
			var t, n;
		};
	...
	const $e = () => {
		...
		et = e => {
			...
			return (
				...
				!nt(e) &&
				(t === n ||
					!(ee(n) || 'INPUT' === t.tagName || 'TEXTAREA' === t.tagName || (ee(k()) && k().contains(t))))
			);
		},
	...
	function it(e, t, n, o) {
		H()
			...
			I() &&
				(null !== q.previousBodyPadding &&
					((document.body.style.paddingRight = ''.concat(q.previousBodyPadding, 'px')),
		...
		_destroy: function () {
			...
			t &&
				(e.popup &&
					...
					(Ie.swalCloseEventFinishedCallback(), delete Ie.swalCloseEventFinishedCallback),
